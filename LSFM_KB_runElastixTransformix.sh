...
export AFFINEPARFILE=/data/rmunozca/Par0008affine.txt
export BSPLINEPARFILE=/data/rmunozca/Par0018bspline.txt
...
$TRANSFORMIX -threads 16 -in $inputImage -tp ./elastixOutput_KB_a_sagittal/TransformParameters_labels.1.txt -out $TRANSFORMIX_OUTPUT_DIR
